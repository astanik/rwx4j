...
import de.tu_berlin.cit.rwx4j.xwadl.MethodType.Enum;
...
public class ResourceClient {
	...
	private final XwadlDocument doc;

	public ResourceClient(XwadlDocument doc) {
		this.doc = doc;
	}

	public List<Method> getMethods(Enum type) {
		Method[] xmlMethods = this.doc.getXwadl().getMethodArray();
